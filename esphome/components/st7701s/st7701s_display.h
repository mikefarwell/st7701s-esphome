...
static const uint8_t ST7701S_TFTWIDTH_128 = 128;   // for 1.44 and mini^M
static const uint8_t ST7701S_TFTWIDTH_80 = 80;     // for mini^M
static const uint8_t ST7701S_TFTHEIGHT_128 = 128;  // for 1.44" display^M
static const uint8_t ST7701S_TFTHEIGHT_160 = 160;  // for 1.8" and mini display^M
...
enum ST7701SModel {
  ST7701S_INITR_GREENTAB = INITR_GREENTAB,
  ST7701S_INITR_REDTAB = INITR_REDTAB,
  ST7701S_INITR_BLACKTAB = INITR_BLACKTAB,
  ST7701S_INITR_MINI_160X80 = INITR_MINI_160X80,
  ST7701S_INITR_18BLACKTAB = INITR_18BLACKTAB,
  ST7701S_INITR_18REDTAB = INITR_18REDTAB
};
...
class ST7701S : public display::DisplayBuffer,
               public spi::SPIDevice<spi::BIT_ORDER_MSB_FIRST, spi::CLOCK_POLARITY_LOW, spi::CLOCK_PHASE_LEADING,
                                     spi::DATA_RATE_8MHZ> {
 public:
  ST7701S(ST7701SModel model, int width, int height, int colstart, int rowstart, bool eightbitcolor, bool usebgr,
         bool invert_colors);
  ...
  void set_model(ST7701SModel model) { this->model_ = model; }
 ...
 protected:
  ...
  ST7701SModel model_{ST7701S_INITR_18BLACKTAB};
